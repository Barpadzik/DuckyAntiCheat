...
public class ConfigManager {
    ...
    public int getAutoTrapAMinWoodBlocks() {
        return config.getInt("auto-trap-a.min-wood-blocks", 6);
    }

    /** Returns minimum web blocks required for AutoTrapA. */
    public int getAutoTrapAMinWebBlocks() {
        return config.getInt("auto-trap-a.min-web-blocks", 1);
    }
